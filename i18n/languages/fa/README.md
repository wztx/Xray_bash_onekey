...
دستیار محلی داخلی AI عملکرد و تعمیر و نگهداری وضعیت سلامت Xray/Nginx را در زمان واقعی نظارت می کند، به طور خودکار عیب ها را تشخیص می دهد و پیشنهادات درمانی را بدون نیاز به API خارجی ارائه می دهد. ورودی منوی اصلی`9`یا اجرا کنید`idleleo --rill-agent`وارد کنید.
...
* از این اسکریپت در محیط تولید بدون تأیید در دسترس بودن استفاده نکنید
* نویسنده: یون شو، تنها پشتیبانی محدودی ارائه می دهد

## قدردانی ها

* بر اساس[wulabing/V2Ray_ws-tls_bash_onekey](https://github.com/wulabing/V2Ray_ws-tls_bash_onekey)توسعه دهد
* اسکریپت شتاب TCP به نقل از[ylx2016/Linux-NetSpeed](https://github.com/ylx2016/Linux-NetSpeed)
